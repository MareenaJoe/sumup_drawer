...
class SaleItems extends StatefulWidget {
  ...
  static const routeSaleName = '/sale_items_screen';
...
class _SaleItemsState extends State<SaleItems> {
                ...
                Padding(
                    ...
                    child: Container(
                        ...
                        child: ListView(children: [
                          _buildFoodItem('Salmon bowl', '\$24.00'),
                          _buildFoodItem('Spring bowl', '\$22.00'),
                          _buildFoodItem('Avocado bowl', '\$26.00'),
                          _buildFoodItem('Berry bowl', '\$24.00')
                        ]))),
                Row(
  ...
  Widget _buildFoodItem(String foodName, String price) {
    return Padding(
